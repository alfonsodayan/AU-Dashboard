  ...
  return (
    <div
      className={`flex space-x-6 px-4 py-8  rounded-xl ${
        className
          ? className
          : "bg-white dark:bg-darkblack-600 text-bgray-600 dark:text-white"
      }`}
    >
      <div>
        <Image
      ...
      <div>
        ...
        <p className="font-semibold text-base  mb-3">{question}</p>
          ...
          <li>
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <circle opacity="1" cx="6" cy="6" r="1.5" />
                <circle opacity="1" cx="1.5" cy="6" r="1.5" />
                <circle opacity="1" cx="10.5" cy="6" r="1.5" />
              </svg>
            </button>
          </li>
        </ul>
